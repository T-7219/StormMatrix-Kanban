...
let DiagnosticService = class DiagnosticService {
    constructor(httpService, configService) {
        ...
        this.activeServices = ['auth-service', 'board-service'];
        this.serviceEndpoints = [
            { name: 'auth-service', url: 'http://auth-service:3001/api/v1/health/ping', phase: 'alpha' },
            { name: 'user-service', url: 'http://user-service:3002/api/v1/health/ping', phase: 'beta' },
            { name: 'board-service', url: 'http://board-service:3003/api/v1/health/ping', phase: 'alpha' },
            { name: 'notification-service', url: 'http://notification-service:3004/api/v1/health/ping', phase: 'beta' },
            { name: 'file-service', url: 'http://file-service:3005/api/v1/health/ping', phase: 'beta' },
        ];
        this.apiEndpoints = [
            ...
            { name: 'users-profile', url: 'http://user-service:3002/api/v1/users/profile', method: 'OPTIONS', phase: 'beta' },
            ...
            { name: 'notifications-list', url: 'http://notification-service:3004/api/v1/notifications', method: 'OPTIONS', phase: 'beta' },
            { name: 'attachments-list', url: 'http://file-service:3005/api/v1/attachments', method: 'OPTIONS', phase: 'beta' },
